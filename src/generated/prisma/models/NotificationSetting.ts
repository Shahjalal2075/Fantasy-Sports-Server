...
export interface NotificationSettingDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const notificationSettingWithEnabledOnly = await prisma.notificationSetting.findMany({ select: { enabled: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many NotificationSettings and only return the `enabled`
   * const notificationSettingWithEnabledOnly = await prisma.notificationSetting.createManyAndReturn({
   *   select: { enabled: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more NotificationSettings and only return the `enabled`
   * const notificationSettingWithEnabledOnly = await prisma.notificationSetting.updateManyAndReturn({
   *   select: { enabled: true },
   *   where: {
   *     // ... provide filter here
   *   },
